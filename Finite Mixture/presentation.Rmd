...
### Mclust
```{r Normal_Mixture, message=FALSE, warning=FALSE}
...
#table(wines[,1],cn.wines.mixt$)
#print(paste("AdjustedRandIndex:",round(adjustedRandIndex(wines[,1],cn.wines.mixt$classification),3)))
```
